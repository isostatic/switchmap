...
<link rel='stylesheet' href='https://cdnjs.cloudflare.com/ajax/libs/jquery.tablesorter/2.31.0/css/theme.default.min.css'></link>
...
<hr>
<div class="trailer">
This web page was generated by the "$MyName" program (version $Constants::VERSION) on $timstr, on $host<br>
The program is available at
<a href="$url">
$url</a>, with minor modifications at <a href="https://github.com/isostatic/switchmap">https://github.com/isostatic/switchmap</a>
