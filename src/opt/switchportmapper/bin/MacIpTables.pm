...
#
# This function uses DNS to reverse-resolve each IP address into a
# name, to fill a hash named MacHostName.
#
sub GetHostNames () {
  my $logger = get_logger('log2');
